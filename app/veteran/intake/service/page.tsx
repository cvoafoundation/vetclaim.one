  ...
  return (
    <main className="min-h-screen bg-paper px-6 py-10">
      <div className="max-w-lg mx-auto">
        <p className="font-mono text-xs text-muted mb-1">step 1 of 6</p>
        <h1 className="font-serif text-2xl mb-2">Your service history</h1>
        ...
        <form action={saveServicePeriod} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-ink text-paper py-2.5 text-sm mt-6"
          >
            Continue
          </button>
        </form>
